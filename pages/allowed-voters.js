    ...
    <div className={Style.createVoter}>
        ...
        {!fileUrl && (
          <div className={Style.sideInfo}>
            <div className={Style.sideInfo_box}>
              ...
              <p>
                Blockchain voting organization provides an Ethereum blockchain
                ecosystem which has secure information.
              </p>
      ...
      <div className={Style.voter}>
        ...
        <div className={Style.input__container}>
          ...
          <Input
            ...
            handleClick={(e) =>
              setFormInput({ ...formInput, aadhar: e.target.value })
            }
          />
      ...
      <div className={Style.createdVorter}>
        <div className={Style.createdVorter__info}>
          ...
          <p>Notice</p>
          <p>
            Organizer <span>Dhanush#2121</span>
          </p>
          <p>
            Only the organizer of the voting contract can create a voter and
            candidate for the voting election.
          </p>
        </div>
      </div>
      {loader && <Loader />}
